# MindBox Contracts (Soroban)

Soroban smart contracts for MindBox. Today there is one:
...
anyone can read it directly from the chain without trusting the MindBox API.
...
Fill in the fields below with your own deployment (the `C...` / `G...` values are placeholders):

| Field            | Value                                                                   |
| ---------------- | ----------------------------------------------------------------------- |
| Contract ID      | `C...`                                                                  |
| Wasm Hash        | `<your-wasm-hash>`                                                      |
| Deployer Address | `G...`                                                                  |
| Network          | Stellar Testnet (`Test SDF Network ; September 2015`)                   |
| Soroban RPC      | `https://soroban-testnet.stellar.org`                                   |
| Deployment Date  | 2026-05-27                                                              |
| Explorer         | [stellar.expert](https://stellar.expert/explorer/testnet/contract/C...) |
