...
| `VAULT_REGISTRY_CONTRACT_ID` | **yes**  | —                                     | Contract ID of the deployed `vault-registry` Soroban contract. The testnet canonical deployment is `C...`. See `contract/README.md` for how to deploy your own. |
